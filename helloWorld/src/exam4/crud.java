...
public class crud {
	public static void main(String[] args) {
		...
		String uri = "jdbc:mysql://localhost:3306/exam4";
		String user = "root";
		String pass = "";
		
//		create(
//			uri, user, pass,
//			"clientes", "Pavi", "pavi@pavi.com"
//		);
//		create(
//			uri, user, pass,
//			"productos", "pc", "123"
...
//		);
	...
	public static void create(String uri, String user, String pass, String tabla, String param1, String param2) {
		try {
...
//			System.out.println("Registros insertados: " + registrosInsertados);
	...
	public static void delete(String uri, String user, String pass, String tabla, byte id) {
		try {
...
//			System.out.println("Registros insertados: " + registrosInsertados);
	...
	public static void get(String uri, String user, String pass, String tabla) {
		try {
	...
	public static void update(String uri, String user, String pass, String tabla, String param1, byte param2) {
		try {
